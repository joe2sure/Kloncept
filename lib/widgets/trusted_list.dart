...
class TrustedList extends StatelessWidget {
  bool _visible;
  ...
  Widget showTrusted(List<DummyTrustedCompany> trustedList) {
    return Container(
        margin: EdgeInsets.only(top: 10, left: 12.0),
        height: 70,
        child: Center(
            ...
            itemBuilder: (context, index) {
              return Container(
                ...
                child: CachedNetworkImage(
                  imageUrl: trustedList[index].imageUrl,
  ...
  Widget build(BuildContext context) {
    // Use DummyHomeDataProvider instead of HomeDataProvider
    final dummyHomeProvider = Provider.of<DummyHomeDataProvider>(context);
    final trustedList = dummyHomeProvider.trustedList;
    
    return SliverToBoxAdapter(
      child: _visible == true ? showTrusted(trustedList) : showShimmer(),
    );
  }
}
