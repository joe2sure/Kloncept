...
//                                 ? AssetImage(
//                                     "assets/placeholder/searchplaceholder.png") as ImageProvider
//                                 : CachedNetworkImageProvider("${APIData.courseImages}" + searchcou[index].previewImage.toString()))),
//                   ),
//                   title: Text(searchcou[index].title.toString()),
//                 ),
//               );
//             },
//           );
...
//                                         searchcou[index].previewImage.toString()))),
//                   ),
//                   title: Text(searchcou[index].title.toString()),
//                 ),
//               );
