...
import 'package:kloncept/screens/top_up_wallet_screen.dart';
...
class WalletScreenWithDummy extends StatefulWidget {
  const WalletScreenWithDummy({Key? key}) : super(key: key);

  @override
  State<WalletScreenWithDummy> createState() => _WalletScreenWithDummyState();
}

class _WalletScreenWithDummyState extends State<WalletScreenWithDummy> {
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final walletProvider = Provider.of<DummyWalletDetailsProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<DummyWalletDetailsProvider>(
        builder: (_, provider, __) {
          // Handle loading state
          if (provider.walletModel == null) {
