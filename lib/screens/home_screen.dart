...
class Search extends SearchDelegate<String> {
  ...
  Widget buildResults(BuildContext context) {
    final results = list.where((item) => item.toLowerCase().contains(query.toLowerCase())).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestions = list.where((item) => item.toLowerCase().contains(query.toLowerCase())).toList();
    return ListView.builder(
