...
import 'package:kloncept/provider/user_details_provider.dart';
...
class _SignInScreenState extends State<SignInScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      // Using DummyHomeDataProvider instead of HomeDataProvider
      DummyHomeDataProvider homeData =
          Provider.of<DummyHomeDataProvider>(context, listen: false);
      
      // Load dummy home data instead of fetching from API
      homeData.loadDummyHomeData();
      ...
      if (await storage.containsKey(key: 'selectedCurrency') &&
        ...
        // Fix for the currency access - using the correct property from DummyCurrency
        selectedCurrency = homeData.currencies?.name; // Changed from currency to name
  ...
  Future<void> _simulateLogin(String email, String password) async {
    ...
    // Generate and persist a dummy token
    String dummyToken = "dummy_token_${DateTime.now().millisecondsSinceEpoch}";
    await storage.write(key: "token", value: dummyToken);
        ...
        child: ElevatedButton(
          ...
          onPressed: userDetails.getSignInEmail
              ? () async {
                  ...
                  if (userDetails.getEmail.value == null ||
                      userDetails.getPass.value == null) {
                  ...
                  await _simulateLogin(
                      userDetails.getEmail.value!, userDetails.getPass.value!);
          ...
          Expanded(
            child: ButtonTheme(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await _simulateLogin("google_user@example.com", "password");
                },
                label: Text(
                  "Sign in with Google",
                  style: TextStyle(
          ...
          Expanded(
            child: ButtonTheme(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await _simulateLogin("facebook_user@example.com", "password");
                },
              ),
            ),
          ),
          ...
          Expanded(
            child: ButtonTheme(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await _simulateLogin("guest_user@example.com", "password");
                },
                label: Text(
                  "Sign in as Guest",
                  style: TextStyle(
  ...
  // Login view
  Widget loginView(width, homeData, scaffoldKey) {
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: Column(
            ...
            children: <Widget>[
              // Updated to use sliderList[0].imageUrl as the logo source
              logo(homeData.sliderList.isNotEmpty ? homeData.sliderList[0].imageUrl : null),
              SizedBox(height: 30),
              EmailField(),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Text(
                    "© 2023 All Rights Reserved", // Static copyright text since we're using dummy data
                    style: TextStyle(
                        fontFamily: "Mada",
  ...
  Widget build(BuildContext context) {
    ...
    // Changed to use DummyHomeDataProvider
    var homeData = Provider.of<DummyHomeDataProvider>(context);
    return PopScope(
        canPop: canPopNow,
        child: Scaffold(
          key: scaffoldKey,
          ...
          body: homeData.sliderList.isEmpty
              ? Center(child: CircularProgressIndicator())
              : loginView(width, homeData, scaffoldKey),
        ),
...
// import 'package:kloncept/services/firebase_auth.dart';
...
//     // Simulate a successful login and generate a dummy token
//     String dummyToken = "dummy_token_12345";

//     // Navigate to the LoadingScreen with the dummy token
//     Navigator.pushReplacement(
//       context,
//       MaterialPageRoute(
...
//                     _simulateLogin(context); // Simulate login
//                   }
//                 },
//                 child: Text('Sign In'),
//               ),
